import torch
import numpy as np
from utils.functions_revision import load_problem, reconnect
from utils.insertion import random_insertion
from heatmap.gfncvrp.inst import sum_cost
...
def eval(tsp_insts, n_tsps_per_route, opts):
    ...
    pi_all = [random_insertion(instance[:,:2], order)[0] for instance in seeds]
